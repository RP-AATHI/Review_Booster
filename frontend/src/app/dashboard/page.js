...
import { QrCode, Star, MessageSquare, Ticket, TrendingUp, BarChart3 } from 'lucide-react';
    ...
    return (
        <div className="p-6 max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <StatCard title="Total QR Scans" value={stats.totalScans} icon={QrCode} colorClass="bg-blue-100 text-blue-600" trend="+12%" />
                <StatCard title="Google Reviews" value={stats.googleRedirects} icon={Star} colorClass="bg-green-100 text-green-600" trend="+8%" />
                <StatCard title="Private Feedback" value={stats.privateFeedback} icon={MessageSquare} colorClass="bg-red-100 text-red-600" />
                <StatCard title="Coupons Redeemed" value={stats.couponsRedeemed} icon={Ticket} colorClass="bg-purple-100 text-purple-600" />
            </div>
